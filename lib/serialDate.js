 ...
 * @param {boolean} [options.nativeDate=false]
 *   Makes this function return a native Date object rather than an array of
 *   date values (`[ 1978, 5, 17, 0, 0, 0 ]`).
 * @returns {Date|Array<number>} returns an array of date parts or Date depending on options
 */
