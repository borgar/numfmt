...
test('Exponential 0E+00', t => {
  ...
  t.equal(_f(99999999999), '1E+11');
  t.equal(_f(10000000000), '1E+10');
  t.equal(_f(9999999999), '1E+10');
  t.equal(_f(1000000000), '1E+09');
  t.equal(_f(999999999), '1E+09');
  t.equal(_f(100000000), '1E+08');
  t.equal(_f(99999999), '1E+08');
  t.equal(_f(10000000), '1E+07');
  t.equal(_f(9999999), '1E+06');
  t.equal(_f(1000000), '1E+06');
  t.equal(_f(999999), '1E+06');
  t.equal(_f(100000), '1E+05');
  t.equal(_f(99999), '1E+05');
  t.equal(_f(10000), '1E+04');
  t.equal(_f(9999), '1E+04');
  t.equal(_f(1000), '1E+03');
  t.equal(_f(999), '1E+03');
  t.equal(_f(100), '1E+02');
  t.equal(_f(99), '1E+02');
  t.equal(_f(10), '1E+01');
  t.equal(_f(9), '9E+00');
  t.equal(_f(1), '1E+00');
  t.equal(_f(0.9), '9E-01');
  t.equal(_f(0.1), '1E-01');
  t.equal(_f(0.09), '9E-02');
  t.equal(_f(0.01), '1E-02');
  t.equal(_f(0.009), '9E-03');
  t.equal(_f(0.001), '1E-03');
  t.equal(_f(0.0009), '9E-04');
  t.equal(_f(0.0001), '1E-04');
  t.equal(_f(0.00009), '9E-05');
  t.equal(_f(0.00001), '1E-05');
  t.equal(_f(0.000009), '9E-06');
  t.equal(_f(0.000001), '1E-06');
  t.equal(_f(0.0000009), '9E-07');
  t.equal(_f(0.0000001), '1E-07');
  t.equal(_f(0.00000009), '9E-08');
  t.equal(_f(0.00000001), '1E-08');
  t.equal(_f(0.000000009), '9E-09');
  t.equal(_f(0.000000001), '1E-09');
  t.equal(_f(0.0000000009), '9E-10');
  t.equal(_f(0.0000000001), '1E-10');
  t.equal(_f(0.00000000009), '9E-11');
  t.equal(_f(0.00000000001), '1E-11');
  t.equal(_f(0.000000000009), '9E-12');
