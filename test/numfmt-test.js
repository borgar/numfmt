...
test('Exponential 0E+00', t => {
  ...
  t.equal(_f(999999999999), '1E+12');
  t.equal(_f(950000000000), '1E+12');
  t.equal(_f(100000000000), '1E+11');
  t.equal(_f(95000000000), '1E+11');
  t.equal(_f(10000000000), '1E+10');
  t.equal(_f(9500000000), '1E+10');
  t.equal(_f(1000000000), '1E+09');
  t.equal(_f(950000000), '1E+09');
  t.equal(_f(100000000), '1E+08');
  t.equal(_f(95000000), '1E+08');
  t.equal(_f(10000000), '1E+07');
  t.equal(_f(9500000), '1E+07');
  t.equal(_f(1000000), '1E+06');
  t.equal(_f(950000), '1E+06');
  t.equal(_f(100000), '1E+05');
  t.equal(_f(95000), '1E+05');
  t.equal(_f(10000), '1E+04');
  t.equal(_f(9500), '1E+04');
  t.equal(_f(1000), '1E+03');
  t.equal(_f(950), '1E+03');
  ...
  t.equal(_f(1), '1E+00');
  t.equal(_f(0.95), '1E+00');
  t.equal(_f(0.14999999), '1E-01');
  t.equal(_f(0.1), '1E-01');
  t.equal(_f(0.014999999), '1E-02');
  t.equal(_f(0.01), '1E-02');
  t.equal(_f(0.0014999999), '1E-03');
  t.equal(_f(0.001), '1E-03');
  t.equal(_f(0.00014999999), '1E-04');
  t.equal(_f(0.0001), '1E-04');
  t.equal(_f(0.000014999999), '1E-05');
  t.equal(_f(0.00001), '1E-05');
  t.equal(_f(0.00000149999999), '1E-06');
  t.equal(_f(0.000001), '1E-06');
  t.equal(_f(0.00000014999999), '1E-07');
  t.equal(_f(0.0000001), '1E-07');
  t.equal(_f(0.000000014999999), '1E-08');
  t.equal(_f(0.00000001), '1E-08');
  t.equal(_f(0.0000000014999999), '1E-09');
  t.equal(_f(0.000000001), '1E-09');
  t.equal(_f(0.00000000014999999), '1E-10');
  t.equal(_f(0.0000000001), '1E-10');
  t.equal(_f(0.000000000014999999), '1E-11');
  t.equal(_f(0.00000000001), '1E-11');
  t.equal(_f(0.0000000000014999999), '1E-12');
  t.equal(_f(0.000000000001), '1E-12');
  t.end();
});
