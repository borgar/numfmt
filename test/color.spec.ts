...
test('formatColor', () => {
  ...
  expect(formatColor('0', 123)).toBe(undefined);
  expect(formatColor('0', 0)).toBe(undefined);
  expect(formatColor('0', -123)).toBe(undefined);
  expect(formatColor('0', 'foo')).toBe(undefined);
  expect(formatColor('[blue]0', 123)).toBe('blue');
  expect(formatColor('[blue]0', 0)).toBe('blue');
  expect(formatColor('[blue]0', -123)).toBe('blue');
  expect(formatColor('[blue]0', 'foo')).toBe(undefined);
  ...
  expect(formatColor('[color 0]0', 0)).toBe(undefined);
  ...
  expect(formatColor('[color 0]0', 0, { indexColors: false })).toBe(undefined);
